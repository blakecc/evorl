...
parser.add_argument('-l', '--list', default='none', type=str,
                    help="Model list json")
parser.add_argument('-n', '--modelnumber', default='none', type=int,
                    help="Model number to evaluate")
...
experiment_time_limit_secs = 12*60*60
...
model_list = args.list

# model_number_to_run = 0
model_number_to_run = args.modelnumber
...
run_experiment_chromosome_mod(model_list_data[model_number_to_run], log_directory)
